		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav js-nav-add-active-class">
					...
					<li class="visible-xs-block"><a href="create_account.jsp">Create new account</a></li>
					
					<!--  <li><a href="deposit.jsp">Deposit</a></li>
					<li><a href="withdraw.jsp">Withdraw</a></li>
					<li><a href="transfer.jsp">Transfer</a></li>
					<li><a href="close_account.jsp">Close A/C</li>-->
					<li class="hidden-xs-block"><a href="/about.html">About
							Us</a></li>
					<li class="hidden-xs-block"><a href="/careers.html">Careers</a></li>
					<li class="hidden-xs-block"><a href="/press-release.html">Press
							Release</a></li>
					<li class="hidden-xs-block"><a
				...
				<ul class="nav navbar-nav navbar-right hidden-xs">
					<a type="button" class="navbar-btn btn btn-info"
						am-latosans="bold" href="create_account.jsp">Registration</a>
				</ul>

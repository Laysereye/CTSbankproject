							...
							<div class="space" style="margin-top:20px"></div>
								...
								<div style="margin-bottom: 12px" class="input-group">
									<span class="input-group-addon"><i
										...
										id="login-username" type="text" class="form-control required"
								...
								<div style="margin-bottom: 12px" class="input-group">
									<span class="input-group-addon"><i
										...
										id="login-password" type="password" class="form-control required"
										name="password" placeholder="Password" required>
								</div>
								<% String no=(String)request.getAttribute("b");
								if(no!=null)
								{
									if("NO".equals(no))
									{
